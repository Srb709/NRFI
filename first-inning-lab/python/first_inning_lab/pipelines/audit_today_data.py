...
def run(date: str):
    ...
    for g in games:
        ...
        rows.append({"game":g.get("game"),"game_id":g.get("game_id"),"historical_dataset_available":fs.get("historical_first_inning_available"),"historical_venue_factor_available":fs.get("historical_venue_factor_available"),"historical_team_profile_available":(raw.get("historical_team_away") or {}).get("available") and (raw.get("historical_team_home") or {}).get("available"),"historical_pitcher_profile_available":(raw.get("historical_pitcher_away") or {}).get("available") and (raw.get("historical_pitcher_home") or {}).get("available"),"park_or_venue_signal_available":fs.get("park_or_venue_signal_available"),"top_blockers":blockers})
